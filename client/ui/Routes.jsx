...
const Routes = ({ l }) => (
  <TheRoute.Switch>
    ...
    <TheRoute exact path={Urls.ABOUT_TERMS_OF_USE_URL} component={AboutTermsOfUseView}/>
    <TheRoute exact path={Urls.ABOUT_PRIVACY_POLICY_URL} component={AboutPrivacyPolicyView}/>
